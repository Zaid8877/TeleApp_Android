...
import com.telespecialists.telecare.adapter.MyCalendarEvent
import com.telespecialists.telecare.adapter.SampleEvent
import com.telespecialists.telecare.adapter.SampleEventAgendaAdapter
import com.telespecialists.telecare.utils.isSameDay
...
class CalenderActivity : AppCompatActivity() {
   ...
   /* private var oldDate: Calendar? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        eventList.add(
            MyCalendarEvent(day, day,
                DayItem.buildDayItemFromCal(day), SampleEvent(1, "Birthday", "Today is my birthday")
